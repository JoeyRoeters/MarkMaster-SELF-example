...
/**
 * @method self filterById($int, Criteria $criteria = Criteria::EQUALS)
 * @method self filterByName($name, Criteria $criteria = Criteria::EQUALS)
 * @method self filterByEmail($email, Criteria $criteria = Criteria::EQUALS)
 * @method self filterByPassword($password, Criteria $criteria = Criteria::EQUALS)
